package Test1;
	...
	public class LinkedList {
		...
		//	System.out.println("Unique elements in arr1[] : " + intList1);
			intList.containsAll(intList1);
			System.out.println("contains in arr[] : " + intList);
		}
		...
		public void removeInteger() {
			 ...
			 */
			    ...
			    intList.remove(4);
			    System.out.println("removal"+intList); // observe the output carefully
